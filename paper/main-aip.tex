...
% ---------------------------------------------------------------------------
% Figure macros (AIP format: figure* for wide, figure for single-column)
% ---------------------------------------------------------------------------

\newcommand{\figGridConvergence}{%
  \begin{figure}[htbp]
  \centering
  \includegraphics[width=\columnwidth]{figures-aip/grid_convergence.pdf}
...
\newcommand{\figRegimeDiagram}{%
  \begin{figure*}[htbp]
  \centering
  \includegraphics[width=\textwidth]{figures-aip/regime_diagram.pdf}
...
\newcommand{\figViscositySlices}{%
  \begin{figure*}[htbp]
  \centering
  \includegraphics[width=\textwidth]{figures-aip/viscosity_slices.pdf}
  \caption{Cycle-averaged viscosity ratio versus stratification parameter
  $\Lambda$ for six $(Re, S)$ slices.  Dashed line:
...
\newcommand{\figCriticalLambda}{%
  \begin{figure}[htbp]
  \centering
  \includegraphics[width=\columnwidth]{figures-aip/critical_lambda.pdf}
...
\newcommand{\figProductionDiagnostics}{%
  \begin{figure*}[htbp]
  \centering
  \includegraphics[width=\textwidth]{figures-aip/production_diagnostics.pdf}
  \caption{Phase~4 production diagnostics.
  (a)~Drag coefficient $c_f$ and (b)~cycle-averaged kinetic energy
...
\newcommand{\figPhasePortraits}{%
  \begin{figure*}[htbp]
  \centering
  \includegraphics[width=\textwidth]{figures-aip/phase_portraits.pdf}
...
\newcommand{\figReentrantProfiles}{%
  \begin{figure*}[htbp]
  \centering
  \includegraphics[width=\textwidth]{figures-aip/reentrant_profiles.pdf}
...
\newcommand{\figDampingComparison}{%
  \begin{figure*}[htbp]
  \centering
  \includegraphics[width=\textwidth]{figures-aip/damping_comparison.pdf}
...
\author{Shmuel Link}
\email{sglink@gmail.com}
\affiliation{Independent Researcher, Santa Cruz, California, United States}
